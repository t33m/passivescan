...
class PassiveScan(object):
	def __init__(self, args):
		...
		self.__apis = []
		if args.shodan: self.__apis.append(shodan.Shodan(config.SHODAN_API_KEY))
		if args.censys: self.__apis.append(censys.ipv4.CensysIPv4(config.CENSYS_API_ID, config.CENSYS_SECRET))
